      ...
      <div class="pt-36 md:pt-40 md:pb-20">
        ...
        <div class="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
          ...
          <div class="md:w-[600px]">
            ...
            <!-- Copy -->
            <h1 class="h1 text-white mb-6" data-aos="fade-up" data-aos-delay="100">Create physical and virtual cards for your <span class="relative inline-flex items-center justify-center">
            ...
            <p class="text-lg text-blue-200 mb-8" data-aos="fade-up" data-aos-delay="200">Our landing page template works on all devices, so you only<br class="hidden md:block" /> have to set it up once, and get beautiful results forever.</p>
            ...
            <div class="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4 mb-12 md:mb-0" data-aos="fade-up" data-aos-delay="300">
              ...
              <div>
                <router-link class="btn-sm w-full inline-flex items-center text-white bg-linear-to-tr from-blue-400 hover:bg-blue-500 shadow-xs relative before:absolute before:inset-0 before:bg-blue-400/60 before:-z-10 before:rounded-full" to="/support">Read documentation</router-link>
              </div>
            </div>
          ...
          <div class="max-w-sm mx-auto md:max-w-none md:absolute md:left-[600px] md:top-0 -mb-12 md:-mt-12 md:mb-0">
            <div class="relative -ml-3 -mr-24 md:mx-0">
              ...
              <img src="../images/hero-image.png" class="md:max-w-none" width="548" height="545" alt="Credit card" data-aos="fade-up" />
            </div>
          </div>
